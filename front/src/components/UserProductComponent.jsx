    ...
    function updatesearch(e){
     ...
     function addProduct(id){
      axios.get(`https://inventory-mini.vercel.app/api/products/${id}`).then(res=>{
        ...
        axios.get(`https://inventory-mini.vercel.app/api/orders/${uid}`).then(res=>{
          let order=res.data;
          oid=order._id
          ...
          axios.put(`https://inventory-mini.vercel.app/api/orders/${oid}`,order).then(res=>{
            ...
            axios.put(`https://inventory-mini.vercel.app/api/products/${id}`,product).then(res=>{
...
//=============== code from github direct copy and paste=========================//
// import Alert from '@mui/material/Alert';
// import CheckIcon from '@mui/icons-material/Check';
// import 'bootstrap/dist/css/bootstrap.min.css';
// import SearchIcon from '@mui/icons-material/Search';
